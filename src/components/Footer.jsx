      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Empower your future with knowledge. Our mission is to provide high-quality education accessible to everyone, regardless of their background.
            </p>
            
            <div className="flex space-x-4 mb-8">
              <a href="#" className="bg-gray-800 hover:bg-blue-600 rounded-full w-10 h-10 flex items-center justify-center transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8 pb-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-6">Get the latest updates, tips and special offers sent directly to your inbox.</p>
            
            <form className="max-w-md mx-auto flex gap-2">
              <input 
                type="email" 
                placeholder="Enter your email" 
                className="bg-gray-800 text-white px-4 py-3 rounded-lg flex-grow focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
              <button 
                type="submit" 
                className="bg-blue-600 text-white px-5 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors"
              >
                Subscribe
              </button>
            </form>
